...
def main() -> None:
    ...
    parser.add_argument("--width", type=int, help="PNG width. Defaults to 1600 rectangular/fan or 1200 circular/spiral.")
    parser.add_argument("--height", type=int, help="PNG height. Defaults to 1000 rectangular/fan or 1200 circular/spiral.")
