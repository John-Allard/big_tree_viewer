...
def main() -> None:
    ...
    parser.add_argument("--width", type=int, help="PNG width. Defaults to 1600 except for square 1200-pixel spiral exports.")
    parser.add_argument("--height", type=int, help="PNG height. Defaults to 1000 except for square 1200-pixel spiral exports.")
